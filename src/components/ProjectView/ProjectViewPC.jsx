...
function ProjectView({ onClose }){
    ...
    const handleScroll = () => {
        ...
        smoothScrollTo(el, el.scrollHeight, 20000);
        }
    };
            ...
            <div className='projectView-container-wrap ver-pc'>
                ...
                <div className='projectView-container'>
                    <div className='projectView-screen' ref={screenRef}>
                        <LazyLoadImage src='/fullpic-freya-pc.png' alt='gaming landing page-freya' effect='opacity'/>
                    </div>
                ...
                <div className='projectView-description'>
                    ...
                    <div className='projectView-description-box'>
                        <div className='projectView-yt'>
                           <iframe
                                src="https://www.youtube.com/embed/eueIY_kEy4s?autoplay=1&loop=1&playlist=eueIY_kEy4s&controls=0&modestbranding=1&rel=0"
